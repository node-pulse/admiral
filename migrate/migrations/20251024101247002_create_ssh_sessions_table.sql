...
CREATE TABLE IF NOT EXISTS admiral.ssh_sessions (
    ...
    user_id BIGINT, -- References users table (Flagship/Laravel user who opened terminal), no FK
...
COMMENT ON COLUMN admiral.ssh_sessions.user_id IS 'References users table (Flagship/Laravel user who initiated the connection)';
