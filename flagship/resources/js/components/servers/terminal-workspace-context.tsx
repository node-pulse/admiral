...
const TerminalWorkspaceContext = createContext<
    TerminalWorkspaceContextType | undefined
>(undefined);
...
export function TerminalWorkspaceProvider({
    ...
    const updateSessionOutput = useCallback(
...
export function useTerminalWorkspace() {
    ...
    if (!context) {
        throw new Error(
            'useTerminalWorkspace must be used within TerminalWorkspaceProvider',
        );
    }
    return context;
}
