                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-5 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        href="https://github.com/node-pulse/admiral/releases"
                                        target="_blank"
                        ...
                        <div className="relative -mb-px flex aspect-335/376 w-full shrink-0 items-center justify-center overflow-hidden rounded-t-lg bg-white p-8 lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            <img
                                src="/nodepulse.jpg"
                                alt="Node Pulse Logo"
                                className="h-full w-full translate-y-0 object-contain opacity-100 transition-all duration-750 starting:translate-y-6 starting:opacity-0"
                            />
