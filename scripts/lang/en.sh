...
MSG_PREREQUISITES_PASSED="✓ Prerequisites check passed"
...
MSG_COMPOSE_FOUND="✓ compose.yml found"
MSG_COMPOSE_NOT_FOUND="Error: compose.yml not found"
MSG_CADDYFILE_FOUND="✓ caddy/Caddyfile.prod found"
...
MSG_LOADED_CONFIG="✓ Loaded existing configuration"
MSG_BACKED_UP_ENV="✓ Backed up existing .env to"
...
MSG_MASTER_KEY_EXISTS="✓ Master key file already exists"
MSG_MASTER_KEY_LOCATION="  Location:"
MSG_KEEP_MASTER_KEY="Keep existing master key? (Y/n):"
MSG_USING_EXISTING_KEY="✓ Using existing master key"
MSG_BACKED_UP_KEY="✓ Backed up existing key to"
MSG_NEW_KEY_GENERATED="✓ New master key generated"
MSG_REENCRYPT_WARNING="⚠️  All existing SSH keys will need to be re-imported!"
MSG_GENERATING_KEY="Generating new master key for SSH private key encryption..."
MSG_KEY_GENERATED="✓ Master key generated successfully"
MSG_KEY_FORMAT="  Format: 64-character hex (32 bytes for AES-256-CBC)"
MSG_KEY_PERMISSIONS="  Permissions: 644 (readable by containers)"
MSG_BACKUP_KEY_HEADER="━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
MSG_BACKUP_KEY_WARNING="⚠️  IMPORTANT: BACKUP THIS KEY AFTER DEPLOYMENT!"
...
MSG_KEY_BACKUP_PASSWORD_MANAGER="  • Password manager (1Password, Bitwarden, etc.)"
MSG_KEY_BACKUP_USB="  • Encrypted USB drive"
MSG_KEY_BACKUP_CLOUD="  • Secure cloud storage (encrypted)"
...
MSG_KEY_NOT_FOUND="✗ Master key file not found!"
...
MSG_KEY_EXISTS_VERIFIED="✓ Master key file exists"
MSG_FIXING_PERMISSIONS="⚠  Fixing file permissions (should be 644 for container access)"
MSG_CURRENT_PERMS="   Current:"
MSG_EXPECTED_PERMS="Expected:"
MSG_PERMISSIONS_CORRECTED="✓ Permissions corrected"
MSG_KEY_FILE_EMPTY="✗ Master key file is empty!"
...
MSG_CATALOG_CREATED="✓ Created ansible/catalog directory"
MSG_CATALOG_EXISTS="✓ ansible/catalog directory already exists"
...
MSG_SMTP_CONFIGURED="✓ SMTP mail configured"
MSG_MAIL_LOG_SET="✓ Mail set to 'log' driver (emails logged, not sent)"
...
MSG_CONFIG_CONFIRMED="✓ Configuration confirmed"
...
MSG_PULL_WARNING="⚠  Warning: Failed to pull some Docker images"
...
MSG_ADMIN_SUCCESS="✓ Admin user setup completed successfully"
MSG_ADMIN_SETUP_SUCCESS="✓ Admin user setup completed successfully"
MSG_REMOVING_CREDENTIALS="Removing admin credentials from .env file..."
MSG_CREDENTIALS_REMOVED="✓ Credentials removed from .env (now stored securely in database)"
MSG_SEEDER_FAILED="✗ Admin user seeder failed (exit code:"
...
MSG_SAVE_CREDENTIALS="⚠️  Save these credentials - they won't be shown again!"
...
MSG_KEEP_ENV_SECURE="⚠️  Keep your .env file secure (contains secrets)"
MSG_DB_PASSWORD="⚠️  Database password:"
MSG_FILE_PERMISSIONS="⚠️  File permissions set to 600 (owner read/write only)"
MSG_SECURITY_ENV="  ⚠️  Keep your .env file secure (contains secrets)"
MSG_SECURITY_DB_PASSWORD="  ⚠️  Database password:"
MSG_SECURITY_PERMISSIONS="  ⚠️  File permissions set to 600 (owner read/write only)"
MSG_BACKUP_MASTER_KEY="🔑 IMPORTANT: Backup Your Master Key!"
MSG_KEY_BACKUP_IMPORTANT="🔑 IMPORTANT: Backup Your Master Key!"
...
MSG_PASSWORD_MANAGER="• Password manager (recommended)"
MSG_ENCRYPTED_USB="• Encrypted USB drive"
MSG_SECURE_CLOUD="• Secure cloud storage"
MSG_WITHOUT_KEY="⚠️  WITHOUT THIS KEY, YOU CANNOT DECRYPT SSH PRIVATE KEYS!"
MSG_KEY_WARNING="⚠️  WITHOUT THIS KEY, YOU CANNOT DECRYPT SSH PRIVATE KEYS!"
...
MSG_OPTIONAL_SECURITY="ℹ️  Optional Security:"
MSG_OPTIONAL_MTLS="  To enable mTLS authentication for agents:"
MSG_MTLS_ENABLE_INFO="To enable mTLS authentication for agents:"
MSG_OPTIONAL_MTLS_UI="  • Login to Flagship > System Settings > Enable mTLS (one-click)"
MSG_MTLS_LOGIN="• Login to Flagship > System Settings > Enable mTLS (one-click)"
MSG_OPTIONAL_MTLS_CLI="  • OR run: sudo ./scripts/setup-mtls.sh (CLI option)"
MSG_MTLS_CLI="• OR run: sudo ./scripts/setup-mtls.sh (CLI option)"

# Thank You
MSG_THANK_YOU="Thank you for choosing Node Pulse Admiral! 🚀"
