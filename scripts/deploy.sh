...
if [ "$SKIP_CONFIG" != "true" ]; then
    ...
    CONFIG["SESSION_CONNECTION"]="session"  # Use dedicated Redis connection for sessions
    CONFIG["CACHE_STORE"]="redis"
    CONFIG["QUEUE_CONNECTION"]="redis"
    CONFIG["REDIS_CLIENT"]="phpredis"
    CONFIG["REDIS_SESSION_DB"]="2"  # Separate database for sessions
...
SESSION_CONNECTION=${CONFIG[SESSION_CONNECTION]}
...
# Redis database numbers (0=default, 1=cache, 2=sessions)
REDIS_SESSION_DB=${CONFIG[REDIS_SESSION_DB]}
